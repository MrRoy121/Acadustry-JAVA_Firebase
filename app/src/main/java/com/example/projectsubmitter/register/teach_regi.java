...
public class teach_regi extends AppCompatActivity {

    FirebaseAuth fauth;
    FirebaseFirestore fstore;
    String ename, eemail, epass, edept;
    String str = "Teacher";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teach_regi);
        ...
        EditText rdept = findViewById(R.id.rdept);
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(cbox.isChecked()) {
                    ...
                    edept = rdept.getText().toString().trim();
